...
- Created a create_output module to perform the save_to_file function
...
- For larger input files user can use the [terminal implementation](../semester_project_terminal.py) for faster processing.
- Updated README
