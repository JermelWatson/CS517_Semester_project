...
def compute_piecewise_linear_interpolation(times: list[float], temps: list[float]):
    """[The compute_piecewise_linear_interpolation function calculates the slope and y-intercept and 
...
def save_to_file(core: list[float], slope: list[float], times: list[float], core_idx: int):
    ...
    Args:
        core (list[float]): _description_
        slope (list[float]): _description_
        times (list[float]): _description_
        core_idx (int): _description_
    """
